...
1. Check out a tagged release (like `10.7.3`).
1. Run `npm install`
1. Run `node tools/build.js :common abnf apache armasm coffeescript d handlebars haskell http julia nginx properties r scala x86asm yaml`
